...
export const validationSchema = Joi.object({
  ...
  HEALTH_CHECK_DATABASE_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('true'),
  HEALTH_CHECK_DATABASE_TIMEOUT: Joi.number()
    .min(1000)
    .max(30000)
    .default(5000),

  // Redis health check
  HEALTH_CHECK_REDIS_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('true'),
  ...
  HEALTH_CHECK_MONGODB_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('true'),
  ...
  // Memory health check
  HEALTH_CHECK_MEMORY_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('true'),
  ...
  // Disk health check
  HEALTH_CHECK_DISK_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('true'),
  ...
  HEALTH_CHECK_EXTERNAL_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('true'),
  HEALTH_CHECK_EXTERNAL_URLS: Joi.string().default('https://www.google.com'),
  HEALTH_CHECK_EXTERNAL_TIMEOUT: Joi.number()
    .min(1000)
    .max(30000)
    .default(5000),
});
