...
describe("Health Library Integration Tests", () => {
  ...
  beforeAll(async () => {
    ...
    enhancedHealthService = module.get<EnhancedHealthService>(EnhancedHealthService);
    enhancedHealthController = module.get<EnhancedHealthController>(EnhancedHealthController);
  ...
  describe("Health Indicators Integration", () => {
    it("should have all required indicators available", () => {
      const enhancedPrismaIndicator = module.get("EnhancedPrismaHealthIndicator", {
        strict: false,
      });
      const queueIndicator = module.get("QueueHealthIndicator", { strict: false });
      const redisIndicator = module.get("RedisHealthIndicator", { strict: false });
      const mongoIndicator = module.get("MongoHealthIndicator", { strict: false });
      const systemIndicator = module.get("SystemHealthIndicator", { strict: false });
